...
rem 签名后用beneficiary调用A合约， https://goerli.etherscan.io/address/0x4BF21a02fB505Ce8335FD66430Dc50C31fD677c0#writeContract
cashChequeBeneficiary

接收gBzz的合约地址（任意填）：  0xFE1FC82d87407b87e698C1629822Ecd95bB2BBf9
数量： 10000
